...
<p>Your puzzle answer was <code>10718</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>The Elf finishes helping with the tent and sneaks back over to you. "Anyway, the second column says how the round needs to end: <code>X</code> means you need to lose, <code>Y</code> means you need to end the round in a draw, and <code>Z</code> means you need to win. Good luck!"</p>
...
<p>Your puzzle answer was <code>14652</code>.</p>


## Challenges🎯

📍 Puzzle 1:
`list and dict combo` to replace the key value in the list ,with its key-value from the dict to list

📍 Puzzle 2
Messed up didn't get answer have to look on!