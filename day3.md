...
<p>Your puzzle answer was <code>7967</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>As you finish identifying the misplaced items, the Elves come to you with another issue.</p>
...
<p>Your puzzle answer was <code>2716</code>.</p>

## Challenges🎯

📍Puzzle 1
- forgot to use string slicing for half the item value
- use zip to combine list iteration

📍Puzzle 2
- use list slicing again to form sublists

## Wrap up!🎁

- Use (set) to identify the set commons
- use sublist index to access its elements through the loop
- Magic formulas to get the alphabets values
