...
<p>Your puzzle answer was <code>74394</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>By the time you calculate the answer to the Elves' question, they've already realized that the Elf carrying the most Calories of food might eventually <em>run out of snacks</em>.</p>
...
<p>Your puzzle answer was <code>212836</code>.</p>

## Challenges🎯

- Use join and split to form list from the txt file
- use list comprehension
- forgot to use sorted(reverse=True) to find the top 3 calories